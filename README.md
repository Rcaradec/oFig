...
On considère que tous les callbacks respecteront la signature standard `(err, data)`.
...
- Appeller `dataMapper.getAllFigurines`.
- Définir un callback à passer à `dataMapper.getAllFigurines`.
